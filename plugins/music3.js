...
cmd({
  ...
  try {
    ...
    if (!audioUrl) return reply("⚠️ *soryy !! all servers in flex core failed to fetch your song.* Please try again later or search a song include an artist .");
...
🪄 _FLEX AI MEDIA DELIVERED_ ✨
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'FLEX-CORE AUDIO PLAYER🎧',
          serverMessageId: 143
        }
      }
    });

    reply("📤 *flexing and uploading a very high-quality MP3 for you...*");
    ...
    reply("✅ *YOUR REQUESTED MEDIA IS READY  !* 🎶 enjoy AND flex now!");
